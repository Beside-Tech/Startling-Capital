    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between flex-wrap gap-3">
        <div>
          ...
          <p className="text-xs text-muted-foreground mt-0.5">Startling Capital alumni located across Canada, USA, UK, and Africa</p>
        </div>
...
const DEPT_USERS = [
  { name: "Program Director", role: "Program Manager", program: "All Programs", status: "Active", email: "director@startling-capital.com" },
  { name: "WISE Program Lead", role: "Program Manager", program: "WISE Women", status: "Active", email: "wise@startling-capital.com" },
  { name: "CEI Global Coordinator", role: "Program Manager", program: "CEI Global", status: "Active", email: "global@startling-capital.com" },
  { name: "Application Reviewer 1", role: "Reviewer", program: "Innovator Program", status: "Active", email: "reviewer1@startling-capital.com" },
  { name: "Application Reviewer 2", role: "Reviewer", program: "WISE Women", status: "Active", email: "reviewer2@startling-capital.com" },
  { name: "Selection Committee", role: "Committee Member", program: "All Programs", status: "Active", email: "committee@startling-capital.com" },
];
    ...
    <ProtectedRoute adminOnly>
      <AppLayout>
        <div className="space-y-8 max-w-7xl mx-auto">
          ...
          <div className="flex items-start justify-between">
            <div>
              <h1 className="text-3xl font-bold tracking-tight font-display">Startling Capital Programs</h1>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
            {[
              ...
              { icon: Building2, label: "STEM Businesses", value: "100+", sub: "Black-owned, launched by Startling Capital", color: "text-blue-600 dark:text-blue-400" },
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Status of all three Startling Capital programs</CardDescription>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {[
