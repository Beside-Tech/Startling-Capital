/**
 * Nobellum Email Notification Service
 *
...
function getSubjectAndBody(payload: EmailPayload): { subject: string; text: string; html: string } {
  ...
  const base = {
    submitted: {
      ...
      text: `Hi ${firstName},\n\nWe've received your application to the ${programName} program. Our team will review your submission and be in touch soon.\n\nThank you for applying to Nobellum!\n\nBest regards,\nThe Nobellum Team`,
      html: `<p>Hi <strong>${firstName}</strong>,</p><p>We've received your application to the <strong>${programName}</strong> program. Our selection committee will review your submission carefully and will be in touch soon.</p><p>Thank you for applying to Nobellum!</p><p><em>Best regards,<br>The Nobellum Team</em></p>`,
    },
    under_review: {
      ...
      html: `<p>Hi <strong>${firstName}</strong>,</p><p>Great news! Your application to <strong>${programName}</strong> is now being reviewed by our selection committee. We appreciate your patience and will be in touch with a decision soon.</p><p><em>Best regards,<br>The Nobellum Team</em></p>`,
    },
    shortlisted: {
    ...
    withdrawn: {
      ...
      html: `<p>Hi <strong>${firstName}</strong>,</p><p>Your application to the <strong>${programName}</strong> program has been marked as withdrawn. If this was an error, please contact us.</p><p>We hope to see you in a future cohort!</p><p><em>Best regards,<br>The Nobellum Team</em></p>`,
    },
  };
...
async function sendViaSMTP(payload: EmailPayload, content: ReturnType<typeof getSubjectAndBody>): Promise<void> {
  ...
  await transporter.sendMail({
    from: process.env.SMTP_FROM || `"Nobellum Programs" <noreply@nobellum.com>`,
    to: payload.to,
